...
<form action="/desain/insert" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <form>
                ...
                <div class="form-group">
                    <label for="foto_desain" class="col-form-label">Foto Desain</label>
                        <input type="file" name="foto_desain" class="form-control" placeholder="Ukuran foto maksimal 2MB">
                        @error('foto_desain')
                                <strong>{{ $message }}</strong>
                        @enderror
                </div>
                ...
                <div class="form-group">
                    <label for="foto_desain" class="col-form-label">Tampak Kiri</label>
                        <input type="file" name="tampak_samping_kiri" class="form-control" placeholder="Ukuran foto maksimal 2MB">
                ...
                <div class="form-group">
                    <label for="foto_desain" class="col-form-label">Tampak Kanan</label>
                        <input type="file" name="tampak_samping_kanan" class="form-control" placeholder="Ukuran foto maksimal 2MB">
